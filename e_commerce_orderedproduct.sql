...
CREATE TABLE `orderedproduct` (
  ...
  KEY `FK_VendorProduct` (`VendorProductID`),
  KEY `FK_Order` (`OrderID`),
  CONSTRAINT `FK_Order` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`),
  CONSTRAINT `FK_VendorProduct` FOREIGN KEY (`VendorProductID`) REFERENCES `vendorproduct` (`VendorProductID`)
...
INSERT INTO `orderedproduct` VALUES (1,1,1,2),(2,2,1,1),(3,3,2,5),(4,4,2,3),(5,5,3,2),(6,6,4,1),(7,7,4,6),(8,8,5,4),(9,9,6,3),(10,10,7,5);
